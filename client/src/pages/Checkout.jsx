...
const Checkout = () => {
  const [userdata,setuserdata]=useState({});
    ...
    const stripePromise = loadStripe("pk_test_51QWz5HCY7kDIKPcgOBDYgkfU8sO66HA5lGhYmeHvVciTncnPCmVXPZZHVr7NefG0bEOwOy2Jfp47zOwn1NsYDaiO007THBOiDc");
...
<div className='info' style={{marginLeft:"150px",padding:"20px",borderRadius:"20px", textAlign:"center", fontWeight:600}}>
...
<label htmlFor="">Enter Pincode</label> <input type="text" name='pincode' onChange={changeval}   style={{borderRadius:"20px",border:"none",height:"40px"}}   />
        ...
        <div id="pay" style={{ textAlign: "center" , paddingTop:"10px"}}>
          <Button onClick={handlePay}>Pay Now!</Button>
        </div>
          <h4 align="center" style={{ color: "blue", fontWeight: "bold" }}>
